...
<head>
    ...
    <link rel="stylesheet" crossorigin href="{{ URL::to('assets/compiled/css/table-datatable-jquery.css') }}">
    <link rel="stylesheet" crossorigin href="{{ URL::to('assets/compiled/css/app.css') }}">
    <link rel="stylesheet" crossorigin href="{{ URL::to('assets/compiled/css/app-dark.css') }}">
    <link rel="stylesheet" crossorigin href="{{ URL::to('assets/compiled/css/custom.css') }}">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/choices.js/public/assets/styles/choices.min.css">
    <link href='https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css' rel="stylesheet" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/iconly@latest/dist/iconly.min.css">
...
<body>
    ...
    <script src="{{ asset('assets/compiled/js/custom.js') }}"></script>
</body>
